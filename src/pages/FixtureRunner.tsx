/**
 * T16/FR-26 — the actual deliverable.
 *
 * PRD §8: the outcome that matters is the gap between Set A and Set B. This
 * screen exists to make 80 recordings quick to capture and clean to export,
 * because a contaminated fixture invalidates the entire experiment.
 *
...
export function FixtureRunner() {
  ...
  const [referenceText, setReferenceText] = useState("Would you like something to drink");
