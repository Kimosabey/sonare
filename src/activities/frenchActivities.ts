 ...
 * discriminate on.
 *
 * `passScore` is 60, the same boundary the score card uses for its warn band.
 * Keeping one threshold means "amber chip" and "did not pass" cannot disagree.
 */
...
export const FRENCH_ACTIVITIES: Activity[] = [
  {
    id: 1,
    title: "Greetings",
    kind: "repeat",
...
export const FRENCH_LANGUAGE = "fr-FR";
